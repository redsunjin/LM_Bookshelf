...
## 5. Next Work
- [ ] `NotebookLM` 페이지 원클릭 저장 구현 <!-- id: 500 -->
- [ ] 저장 시 기본 폴더 자동 분류 구현 <!-- id: 501 -->
- [ ] NotebookLM 페이지 메타데이터 추출 고도화 <!-- id: 502 -->
- [ ] 최근 저장 항목 정렬/핀 UX 개선 <!-- id: 503 -->
- [ ] 스마트 태그 규칙 확장 및 사용자 편집 UX 추가 <!-- id: 504 -->
- [ ] AI 요약/자동 분류 연동 구조 설계 <!-- id: 505 -->

## 현재 진행 상태

- 현재 단계: `MVP 안정화 + 문서/하네스 정비`
- 다음 목표: `NotebookLM 페이지 저장 흐름 추가`
