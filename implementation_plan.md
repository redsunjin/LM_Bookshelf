...
- 완료: 로컬 스마트 태그 로직
- 완료: `NotebookLM` 페이지 원클릭 저장
- 완료: 저장 시 기본 폴더 자동 분류
- 완료: JSON 백업/복원
- 완료: README/계획/작업/검증 문서 체계
- 완료: 기본 구조 검증 하네스
- 예정: NotebookLM 페이지 메타데이터 추출 강화
...
- `background`
  초기 스토리지 상태 보장 및 NotebookLM 페이지 저장 요청 처리
- `content`
  NotebookLM 페이지 내 원클릭 저장 버튼 제공
...
- NotebookLM 페이지에서 원클릭 저장이 가능할 것
- 검색/필터/수정/삭제/백업/복원 흐름이 수동 테스트를 통과할 것

## 9. 다음 설계 포인트

- NotebookLM 페이지 메타데이터를 얼마나 읽을지
